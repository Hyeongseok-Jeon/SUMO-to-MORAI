...
(cl:in-package sumo2morai_tutorial-msg)
...
(cl:defclass <NpcGhostCmd> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (npc_list
    :reader npc_list
    :initarg :npc_list
    :type (cl:vector sumo2morai_tutorial-msg:NpcGhostInfo)
   :initform (cl:make-array 0 :element-type 'sumo2morai_tutorial-msg:NpcGhostInfo :initial-element (cl:make-instance 'sumo2morai_tutorial-msg:NpcGhostInfo))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <NpcGhostCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NpcGhostCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sumo2morai_tutorial-msg:<NpcGhostCmd> is deprecated: use sumo2morai_tutorial-msg:NpcGhostCmd instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <NpcGhostCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sumo2morai_tutorial-msg:header-val is deprecated.  Use sumo2morai_tutorial-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'npc_list-val :lambda-list '(m))
(cl:defmethod npc_list-val ((m <NpcGhostCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sumo2morai_tutorial-msg:npc_list-val is deprecated.  Use sumo2morai_tutorial-msg:npc_list instead.")
  (npc_list m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <NpcGhostCmd>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'npc_list)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'sumo2morai_tutorial-msg:NpcGhostInfo))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<NpcGhostCmd>)))
  ...
  "sumo2morai_tutorial/NpcGhostCmd")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'NpcGhostCmd)))
  "Returns string type for a message object of type 'NpcGhostCmd"
  "sumo2morai_tutorial/NpcGhostCmd")
