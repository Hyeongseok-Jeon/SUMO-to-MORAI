...
(cl:defmethod cl:initialize-instance :after ((m <NpcGhostInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NpcGhostInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sumo2morai_tutorial-msg:<NpcGhostInfo> is deprecated: use sumo2morai_tutorial-msg:NpcGhostInfo instead.")))

(cl:ensure-generic-function 'unique_id-val :lambda-list '(m))
(cl:defmethod unique_id-val ((m <NpcGhostInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sumo2morai_tutorial-msg:unique_id-val is deprecated.  Use sumo2morai_tutorial-msg:unique_id instead.")
  (unique_id m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <NpcGhostInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sumo2morai_tutorial-msg:name-val is deprecated.  Use sumo2morai_tutorial-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <NpcGhostInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sumo2morai_tutorial-msg:position-val is deprecated.  Use sumo2morai_tutorial-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'rpy-val :lambda-list '(m))
(cl:defmethod rpy-val ((m <NpcGhostInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sumo2morai_tutorial-msg:rpy-val is deprecated.  Use sumo2morai_tutorial-msg:rpy instead.")
  (rpy m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<NpcGhostInfo>)))
  ...
  "sumo2morai_tutorial/NpcGhostInfo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'NpcGhostInfo)))
  "Returns string type for a message object of type 'NpcGhostInfo"
  "sumo2morai_tutorial/NpcGhostInfo")
