...
class MoraiSimpProcSrvRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MoraiSimpProcSrvRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MoraiSimpProcSrvRequest
    let len;
    let data = new MoraiSimpProcSrvRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoraiSimpProcSrvRequest(null);
...
class MoraiSimpProcSrvResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.response = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MoraiSimpProcSrvResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MoraiSimpProcSrvResponse
    let len;
    let data = new MoraiSimpProcSrvResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoraiSimpProcSrvResponse(null);
...
module.exports = {
  Request: MoraiSimpProcSrvRequest,
  Response: MoraiSimpProcSrvResponse,
  md5sum() { return '6d340598acf4b7d6e6f913c45512bf48'; },
  datatype() { return 'morai_msgs/MoraiSimpProcSrv'; }
};
